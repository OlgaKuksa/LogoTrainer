...
namespace Logotrainer.Server.Models
{
    ...
    public class SetPasswordViewModel
    {
        [Required, StringLength(100, ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 6),
         DataType(DataType.Password), Display(Name = "New password")] public string NewPassword { get; set; }
    ...
    {
        [Required, Phone, Display(Name = "Phone Number")] public string Number { get; set; }
    }
    ...
    public class VerifyPhoneNumberViewModel
    {
        ...
        [Required, Phone, Display(Name = "Phone Number")] public string PhoneNumber { get; set; }
    }
